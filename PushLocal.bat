...
c:\exe\nuget add .\Cadmus.Import\bin\Debug\Cadmus.Import.3.0.3.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Cadmus.Import.Excel\bin\Debug\Cadmus.Import.Excel.3.0.3.nupkg -source C:\Projects\_NuGet
pause
